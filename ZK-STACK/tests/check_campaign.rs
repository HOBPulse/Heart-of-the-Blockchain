mod tests {
    ...
    #[test]
    pub fn test_donate_compressed_call() {
...
fn main() {
    ...
    // Test 1: Campos de la campaña
    tests::test_campaign_fields();
    println!("✅ Test 1 passed: Campaign structure has merkle_tree and output_queue fields");
    
    // Test 2: Donate compressed
    tests::test_donate_compressed_call();
    println!("✅ Test 2 passed: donate_compressed_amount function with batch_append CPI works");
    
    // Test 3: Integración 
    tests::test_integration_tasks();
